...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(8) {
				this->Column3,
					this->Column1, this->Column2, this->Column4, this->Column5, this->Column6, this->Column7, this->Column8
			});
			this->dataGridView1->Location = System::Drawing::Point(80, 160);
...
#pragma endregion
	...
	private: void mostrarGrilla(List<AreaDeAnimales^>^ listaAreas) {
		...
		for (int i = 0; i < listaAreas->Count; i++) {
			...
			fila[0] = objArea->tipo_animal;
			fila[1] = objArea->raza;
			fila[2] = objArea->color;
			fila[3] = objArea->sexo;
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ AnimalAreaEditar = (this->dataGridView1->Rows[posicionFilaSeleccionada]->Cells[0]->Value->ToString());
		String^ RazaAreaEditar = (this->dataGridView1->Rows[posicionFilaSeleccionada]->Cells[1]->Value->ToString());

		frmEditarArea^ ventanaEditarArea = gcnew frmEditarArea(AnimalAreaEditar, RazaAreaEditar);
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ RazaAreaEditar = (this->dataGridView1->Rows[posicionFilaSeleccionada]->Cells[1]->Value->ToString());
		AreasDeAnimalesController^ gestor = gcnew AreasDeAnimalesController();
		gestor->eliminarArea(AnimalAreaEditar, RazaAreaEditar);
		gestor->CargarAreasDesdeArchivo();
	...
	private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (animalBuscar == "") {	  //casilla vacia 	
			...
			listaPartidos = objGestor->buscarAreas();
		}
