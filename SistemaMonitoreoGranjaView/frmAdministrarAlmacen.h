...
#pragma endregion
	private: System::Void frmAdministrarAlmacen_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		this->comboBox1->Items->Add("Almacen 1");
		this->comboBox1->Items->Add("Almacen 2");
		this->comboBox1->Items->Add("Almacen 3");
		this->comboBox1->Items->Add("Almacen 4");
		...
		this->comboBox3->Items->Add("Almacen 1");
		this->comboBox3->Items->Add("Almacen 2");
		this->comboBox3->Items->Add("Almacen 3");
		this->comboBox3->Items->Add("Almacen 4");
		...
		this->comboBox6->Items->Add("Almacen 1");
		this->comboBox6->Items->Add("Almacen 2");
		this->comboBox6->Items->Add("Almacen 3");
		this->comboBox6->Items->Add("Almacen 4");

		this->comboBox7->Items->Clear();
		this->comboBox7->Items->Add("Almacen 1");
		this->comboBox7->Items->Add("Almacen 2");
		this->comboBox7->Items->Add("Almacen 3");
		this->comboBox7->Items->Add("Almacen 4");
